...
export const AddressManager: React.FC = () => {
  ...
  const handleDeriveAddress = async () => {
    try {
      ...
      const addressInfo = await rpc.request.deriveAddress({
        account: 0,
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="bg-hacker-black border border-muted-gray p-3">
                  <span className="text-hacker-white font-mono text-sm">{address.derivationPath}</span>
                </div>
              </div>
              <div>
                <label className="block text-muted-gray font-mono text-sm mb-2">Script Type</label>
                <div className="bg-hacker-black border border-muted-gray p-3">
                  <span className="text-hacker-white font-mono text-sm">{address.scriptType}</span>
                </div>
              </div>
            </div>
